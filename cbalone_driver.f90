...
program cbalone_driver
  ...
  real(dp),allocatable,dimension(:,:)  ::  NPP2green   !! HW dummy for subroutine call; not used in cbalone
...
!  real(dp),allocatable,dimension(:,:)  ::  excess_carbon_debug   !! HW dummy for subroutine call; not used in cbalone
  ...
  allocate(NPP2green(1:grid%nland,surface%ntiles))
  NPP2green(:,:)=0.0_dp
              ...
              IF (with_nitrogen) THEN
               ...
               IF (with_yasso) THEN
                 ...
                 CALL update_Cpools(cbalance_diag%LAI_yDaymean(1:grid%nland,1:surface%ntiles,day),         &
                                    ...
                                    NPP2green(1:grid%nland,1:surface%ntiles),                & ! HW
